...
def _api_keys_match(provided: str, expected: str) -> bool:
    """Timing-safe API key compare. Different lengths are a mismatch."""
...
def resolve_http_auth(
    *,
    ...
    if provided:
        ...
        if not _api_keys_match(provided, expected_key):
...
def resolve_auth_context(
    *,
    ...
    if api_key or expected_key:
        ...
        if provided and not _api_keys_match(provided, expected_key):
            raise MCPAuthError("Invalid MCP API key.")
