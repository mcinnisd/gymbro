...
# Description prompt
DESCRIPTION_PROMPT = (
    "You are an expert in food photography analysis. Examine the attached meal image and provide a detailed description of its contents, including types of food, ingredients, portion sizes, and any notable presentation details.\n\n"
    "Return the description in plain text without any additional commentary or analysis."
)
...
def get_description(encoded_image, model_name):
	"""
...
def main():
	...
	for image_name in os.listdir(DISH_PICS_DIR):
		...
		description = get_description(encoded_image, "gpt-4o-mini")
		full_description = "Here is a description of the image. \n" + description + "\n"
		...
		for model in MODELS:
			for i, prompt in enumerate(PROMPTS):
				...
				full_prompt = full_description + prompt
				# print(full_prompt)
